...
convert = function() {
  sce = convert_v7_filtneurons ("/data/780345_2025-02-20_00-00-00/BARseq/combined_neurons_clust_CCFv2.mat")
  dir.create("/results/BARseq_780345/", recursive = TRUE)  # Ensure directory exists
  saveRDS (sce, "/results/BARseq_780345/combined_neurons_clust_CCFv2.rds")    
}
...
#exectute convert function
convert()

############################################################################################################################################################################################################
# Sanity check the converted file
sce <- readRDS('/results/BARseq_780345/combined_neurons_clust_CCFv2.rds')
...
saveRDS(sce, "/results/BARseq_780345/combined_neurons_clust_CCFv2_uid.rds")
...
saveRDS(sce_filtered, file = "/results/BARseq_780345/DBHfilteredneurons_clust_CCFv2_uid.rds")

...
convert = function() {
  sce = convert_v7_filtneurons ("/data/780346_2025-06-11_00-00-00/BARseq/combined_neurons_clust_CCFv2.mat")
  dir.create("/results/BARseq_780346/", recursive = TRUE)  # Ensure directory exists
  saveRDS (sce, "/results/BARseq_780346/combined_neurons_clust_CCFv2.rds")    
}
...
sce <- readRDS('/results/BARseq_780346/combined_neurons_clust_CCFv2.rds')
...
saveRDS(sce, "/results/BARseq_780346/combined_neurons_clust_CCFv2_uid.rds")
...
saveRDS(sce_filtered, file = "/results/BARseq_780346/DBHfilteredneurons_clust_CCFv2_uid.rds")
